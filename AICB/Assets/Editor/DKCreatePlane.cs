...
public class DKCreatePlane : ScriptableWizard
{
	...
	[MenuItem("DK/GameObject/Create Other/Custom Plane...")]
	static void CreateWizard()
	{
		...
		if (!cam)
			...
			lastUsedCam = cam;
		ScriptableWizard.DisplayWizard("Create Plane", typeof(DKCreatePlane));
	}
