...
public class DKCreateHexLattice : ScriptableWizard
{
	...
	[MenuItem("DK/GameObject/Create Other/Custom HexLattice...")]
	static void CreateWizard()
	{
		...
		if (!cam)
			...
			lastUsedCam = cam;
		ScriptableWizard.DisplayWizard("Create HexLattice", typeof(DKCreateHexLattice));
	}
	...
	void OnWizardCreate()
	{
		...
		// Mesh m = (Mesh)AssetDatabase.LoadAssetAtPath("DK_DEBUG/Assets/Editor/" + HexLatticeAssetName, typeof(Mesh));
		Mesh m = (Mesh)AssetDatabase.LoadAssetAtPath("Assets/DK_DEBUG/DUMP/" + HexLatticeAssetName, typeof(Mesh));
		...
		if (m == null)
			{
				...
				//AssetDatabase.CreateAsset(m, "DK_DEBUG/Assets/Editor/" + HexLatticeAssetName);
				AssetDatabase.CreateAsset(m, "Assets/DK_DEBUG/DUMP/" + HexLatticeAssetName);
